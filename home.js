...
console.log(greetUser('jake from statefarm'))
...
console.log(canWeDeliver(85205))// should push 'can deliver'
console.log(canWeDeliver(83709))// shupld push 'can't deliver'
...
const canWeDeliverTwo = (zipCode) => {
    ...
    return"Sorry, out of service area."
}}

console.log (canWeDeliverTwo(85205))
console.log (canWeDeliverTwo(83709))
